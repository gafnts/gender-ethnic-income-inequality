...
p3 <- 
  ...
  annotate("rect", xmin = .02, xmax = .47, ymin = .78, ymax = .92, alpha = .4) +
...
\mbox{}\hfill $R^2$ ajustado: 0.1942 \| Estadístico $F$: 475 (\< 2.2e-16)
...
\mbox{}\hfill $R^2$ ajustado: 0.4479 \| Estadístico $F$: 536.8 (\< 2.2e-16)
...
\mbox{}\hfill $R^2$ ajustado: 0.4985 \| Estadístico $F$: 322.1 (\< 2.2e-16)
